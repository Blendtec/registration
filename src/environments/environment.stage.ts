export const environment = {
  ...
  bucket: 'https://s3-us-west-1.amazonaws.com/apps.stage.blendtec.com/registration',
  s3: 'https://s3-us-west-1.amazonaws.com/data.blendtec.com',
  assets: 'https://s3-us-west-1.amazonaws.com/apps.stage.blendtec.com/registration/assets',
